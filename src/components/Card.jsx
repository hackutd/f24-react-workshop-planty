        ...
        <div className="flex flex-wrap gap-6 justify-center max-w-[1400px]">
          ...
          <div className="bg-backgroundDark rounded-xl p-2 flex justify-center gap-2">
            ...
            <div>
              ...
              <button className="hover:text-text transition duration-150 w-24 mt-2 bg-backgroundDarker text-primary font-bold text-lg rounded-md">water</button>
            </div>
            ...
            <div className="flex flex-col mt-1 mr-24">
              ...
              <h1 className="m-auto text-text font-bold text-5xl">3<span className="text-textLight text-lg">/6 growth</span></h1>
            </div>
          </div>
