        ...
        <div className='bg-black/50 fixed top-0 left-0 z-30 h-screen w-screen flex flex-col'>
            <div className='bg-background flex w-1/3 m-auto rounded-3xl flex-col items-center p-4  md:p-10'>
                ...
                <div className='flex flex-row items-center justify-center'>
                    ...
                    <img className='rounded-full h-36 w-36 object-cover mx-2' src="https://c8.alamy.com/comp/S22E9F/a-random-daisy-basking-in-the-spring-sun-S22E9F.jpg" alt="" />
                ...
                <button onClick={togglePopup} className='bg-backgroundDark text-primary m-6 h-8 w-28 font-bold text-lg font-balsamiq rounded-lg'>plant!</button>
            </div>
        </div>
    );
}
